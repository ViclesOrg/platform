...
export default class Vicles extends builder.Component {
  ...
  #stateChecker(stats, parking, staff, history, settings, title) {
    if (location.pathname.includes("/parking")) {
      if (this.active_tab) this.active_tab.classList.remove("v_active_tab");
  ...
  #activityNavigation(title, activity) {
    let stats = builder.button(
        null,
        "v_vicles_activity_navigation v_stats",
        null,
        '<i class="ri-file-chart-line"></i>',
      ),
      parking = builder.button(
        null,
        "v_vicles_activity_navigation v_park",
        null,
        '<i class="ri-parking-box-line"></i>',
      ),
      staff = builder.button(
        null,
        "v_vicles_activity_navigation v_staff",
        null,
        '<i class="ri-group-3-line"></i>',
      ),
      history = builder.button(
        null,
        "v_vicles_activity_navigation v_hist",
        null,
        '<i class="ri-history-fill"></i>',
      ),
      settings = builder.button(
        null,
        "v_vicles_activity_navigation v_settings",
        null,
        '<i class="ri-settings-2-line"></i>',
      ),
      logout = builder.button(
        null,
        "v_vicles_activity_navigation v_logout",
        null,
  ...
  create() {
    ...
    notifs.onclick = () => {
      this.component.append(this.notifications.getHTML());
    };
  }
}
